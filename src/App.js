    ...
    <div className="App">
      ...
      <Route exact path="/">
        ...
        <div className="filter-sauce">
          {hotSauces
            .filter((hotSauce) => hotSauce.peppers === "Habanero")
            .map((hotSauce) => (
      ...
      <Route path="/hot-sauce">
        <main>
          <p className="hot-sauce">
            {" "}
            Here is a list of the best Hot Sauces from around the world and
            pairing recommendations.
          </p>
          <br /> <hr />
          <div className="add-sauce">
            <h3>Can't find your favorite sauce?</h3>
            <Link to="/new">
      ...
      <Route path="/peppers">
        <main>
          <p className="hot-p">
            {" "}
            Due to the large and changing number of cultivars, and the variation
            of cultivar names in different regions there is an estimated 50,000
            pepper varieties. <br /> HERE ARE A FEW:{" "}
          </p>
          <br /> <hr />
